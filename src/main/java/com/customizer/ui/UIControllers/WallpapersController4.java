...
public class WallpapersController4  {
    ...
    void BtnWallpapers1Clicked(ActionEvent event) {
        ...
        if (WorkSpaseUnlocked){
            ...
            NotificationManager.showNotification("Necessary "+ WorkSpaseCond +" coins to unlock!", BtnWallpapers1);
    }
    ...
    void BtnWallpapers2Clicked(ActionEvent event) {
        ...
        if (FloverUnlocked) 
            ...
            NotificationManager.showNotification("Necessary "+ FloverCond +" coins to unlock!", BtnWallpapers1);
    }
    ...
    void BtnWallpapers3Clicked(ActionEvent event) {
        ...
        if (squirrelUnlocked) 
            ...
            NotificationManager.showNotification("Necessary "+ squirrelCond +" coins to unlock!", BtnWallpapers1); 
    ...
    void BtnWallpapers4Clicked(ActionEvent event) {
        ...
        if (SunsetUnlocked)
            ...
            NotificationManager.showNotification("Necessary "+ SunsetCond +" coins to unlock!", BtnWallpapers1);
    }
