...
import com.customizer.core.AchievementLogic.AchievementReader.AchMainLogic;
...
public class wallpaperAch_1 {

    public wallpaperAch_1() throws IOException
    {
        
        AchMainLogic wpAch_1 = new AchMainLogic(2,...);
    }
